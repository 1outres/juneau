...
const (
	...
	TraceEventReason_TRACE_EVENT_REASON_POLICY_PROTO_DROP        TraceEventReason = 304
	TraceEventReason_TRACE_EVENT_REASON_POLICY_FRAG_DROP         TraceEventReason = 305
...
var (
	TraceEventReason_name = map[int32]string{
		...
		304: "TRACE_EVENT_REASON_POLICY_PROTO_DROP",
		305: "TRACE_EVENT_REASON_POLICY_FRAG_DROP",
	...
	TraceEventReason_value = map[string]int32{
		...
		"TRACE_EVENT_REASON_POLICY_PROTO_DROP":        304,
		"TRACE_EVENT_REASON_POLICY_FRAG_DROP":         305,
...
const file_pkg_debugpb_debug_proto_rawDesc = "" +
	...
	"\x16TRACE_VERDICT_REDIRECT\x10\x03*\x9c\v\n" +
	...
	"$TRACE_EVENT_REASON_POLICY_PROTO_DROP\x10\xb0\x02\x12(\n" +
	"#TRACE_EVENT_REASON_POLICY_FRAG_DROP\x10\xb1\x02\x12*\n" +
