...
type PodIngressL2ArpProbeKey struct {
	_    structs.HostLayout
	Ipv4 uint32
}

type PodIngressL2ArpProbeVal struct {
	_       structs.HostLayout
	AskedNs uint64
}

type PodIngressL2ArpVal struct {
	_   structs.HostLayout
	Mac [6]uint8
	Pad [2]uint8
}

type PodIngressL2FdbKey struct {
	_   structs.HostLayout
	Mac [6]uint8
}

type PodIngressL2FdbVal struct {
	_          structs.HostLayout
	Ifindex    uint32
	VtepIp     uint32
	LastSeenNs uint64
...
type PodIngressL2GatewayKey struct {
	_   structs.HostLayout
	Vni uint32
}

type PodIngressL2GatewayVal struct {
	_       structs.HostLayout
	Ifindex uint32
	Mac     [6]uint8
	Pad     [2]uint8
...
type PodIngressL2IfindexKey struct {
	_       structs.HostLayout
	Ifindex uint32
}

type PodIngressL2IfindexVal struct {
	_   structs.HostLayout
	Vni uint32
}

type PodIngressL2NetworkKey struct {
	_   structs.HostLayout
	Vni uint32
}

type PodIngressL2NetworkVal struct {
	_     structs.HostLayout
	VpcId uint32
}
...
type PodIngressPolicyCtKey struct {
	_     structs.HostLayout
	Epoch uint32
	Scope uint32
	Saddr uint32
...
type PodIngressPolicyCtVal struct {
	_          structs.HostLayout
	State      uint8
	FlagsSeen  uint8
	Pad        [2]uint8
