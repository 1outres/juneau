...
type PodEgressL2ArpAskerKey struct {
	_    structs.HostLayout
	Ipv4 uint32
}

type PodEgressL2ArpAskerVal struct {
	_       structs.HostLayout
	VtepIp  uint32
	Pad     uint32
	AskedNs uint64
...
type PodEgressL2ArpKey struct {
	_    structs.HostLayout
	Ipv4 uint32
}

type PodEgressL2ArpProbeKey struct {
	_    structs.HostLayout
	Ipv4 uint32
}

type PodEgressL2ArpProbeVal struct {
	_       structs.HostLayout
	AskedNs uint64
}

type PodEgressL2ArpVal struct {
	_   structs.HostLayout
	Mac [6]uint8
	Pad [2]uint8
}
...
type PodEgressL2GatewayKey struct {
	_   structs.HostLayout
	Vni uint32
}

type PodEgressL2GatewayVal struct {
	_       structs.HostLayout
	Ifindex uint32
	Mac     [6]uint8
	Pad     [2]uint8
