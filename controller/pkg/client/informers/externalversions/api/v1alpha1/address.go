...
type AddressInformer interface {
	...
	Lister() apiv1alpha1.AddressLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().Addresses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Addresses(namespace).Watch(context.TODO(), options)
			},
		},
		&controllerapiv1alpha1.Address{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *addressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&controllerapiv1alpha1.Address{}, f.defaultInformer)
}

func (f *addressInformer) Lister() apiv1alpha1.AddressLister {
	return apiv1alpha1.NewAddressLister(f.Informer().GetIndexer())
}
