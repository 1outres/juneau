	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().Vpcs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Vpcs().Watch(context.TODO(), options)
			},
		},
		&controllerapiv1alpha1.Vpc{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vpcInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&controllerapiv1alpha1.Vpc{}, f.defaultInformer)
}

func (f *vpcInformer) Lister() apiv1alpha1.VpcLister {
	return apiv1alpha1.NewVpcLister(f.Informer().GetIndexer())
}
