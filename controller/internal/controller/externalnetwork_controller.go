...
// ExternalNetworkReconciler reconciles a ExternalNetwork object
...
// Reconcile is a no-op. ExternalNetwork is a declarative catalog resource whose
// semantics are enforced by the admission webhook and consumers such as ElasticIP.
func (r *ExternalNetworkReconciler) Reconcile(_ context.Context, _ ctrl.Request) (ctrl.Result, error) {
