...
// Reconcile is a no-op. AddressPool is a declarative catalog resource whose
// semantics are enforced by the admission webhook and consumers such as
// ExternalNetwork and BGPAdvertisement.
func (r *AddressPoolReconciler) Reconcile(_ context.Context, _ ctrl.Request) (ctrl.Result, error) {
