...
もう1つ、gatewayがどのNodeで聞いたかによって結果が変わります。返事はホストが乗っているNodeのgatewayに届くので、聞いたNodeが別だとそちらの表は埋まりません。Juneauが配ったアドレスは全Nodeにあらかじめ入っているのでこの影響を受けませんが、Podの中で自分で振ったアドレスやbridgeの向こうのホストは、Node数が増えるほど繋がるまでに時間がかかります。
